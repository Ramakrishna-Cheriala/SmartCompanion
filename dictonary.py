intents = {
    "greetings": {
        ...
        "responses": [
            ...
            "Good afternoon! What do you need assistance with?",
    ...
    "search-google": {
        "patterns": ["search on google", "google search", "google for"],
        "responses": ["Sure, let me find that for you.", "Searching on Google now."],
    },
    "search-youtube": {
        "patterns": ["search on youtube", "youtube search", "search videos"],
        "responses": [
            "Sure, let me find that on YouTube.",
            "Searching on YouTube now.",
        ],
    },
    "jokes": {
        "patterns": [
    ...
    "open-apps": {
        "patterns": [
            "open vs code app",
            "open video player app",
            "open whatsapp",
        ],
        "responses": [
            "Sure, wait a moment",
            "Here's the app you want to open!",
        ],
    },
    "music": {
        "patterns": [
        ...
        "responses": [
            ...
            "Here's a song you might like: [song_name]",
    ...
    "food": {
        ...
        "responses": [
            "Sure, here are some recommended restaurants: [restaurant_names]",
    ...
    "news": {
        ...
        "responses": [
            "Let me fetch the latest news for you.",
            "Here are the top headlines: [news_headlines]",
    ...
    "movies": {
        ...
        "responses": [
            "How about watching [movie_name]?",
            "Here's a movie suggestion for you.",
    ...
    "sports": {
        ...
        "responses": [
            "I'll get you the latest sports updates.",
            "Stay updated with the current sports events!",
    ...
    "gaming": {
        ...
        "responses": [
            "How about trying out [game_name]?",
            "Here are some gaming suggestions for you!",
    ...
    "tech_support": {
        ...
        "responses": [
            "I can assist with technical issues. What problem are you facing?",
    ...
    "book_recommendation": {
        ...
        "responses": [
            "How about reading [book_title]?",
            "I've got some great book recommendations for you!",
    ...
    "fitness_tips": {
        ...
        "responses": [
            "Staying fit is important! Here are some fitness tips: [fitness_tips]",
    ...
    "travel_recommendation": {
        ...
        "responses": [
            "Looking for travel recommendations? Here are some great destinations: [travel_destinations]",
    ...
    "education": {
        ...
        "responses": [
            "I can assist with educational queries. What subject are you studying?",
    ...
    "pet_advice": {
        ...
        "responses": [
            "Pets are wonderful! Here are some pet care tips: [pet_care_tips]",
    ...
    "shopping": {
        ...
        "responses": [
            "I can help you with online shopping. What are you looking to buy?",
            "Let's find the perfect item for you!",
    ...
    "career_advice": {
        ...
        "responses": [
            "I can provide career advice. What specific guidance do you need?",
            "Let's explore career opportunities together.",
            "Tell me about your career goals or concerns.",
        ],
    },
    "relationship_advice": {
        "patterns": [
        ...
        "responses": [
            "Relationships can be complex. How can I assist you?",
            "I can offer advice on relationships and dating.",
            "Tell me about your relationship situation.",
        ],
    },
    "mental_health": {
        "patterns": [
        ...
        "responses": [
            "Mental health is important. How can I support you?",
    ...
    "language_learning": {
        "patterns": [
            ...
            "language study advice",
        ],
        "responses": [
            "Learning a new language can be exciting! How can I assist you?",
...
websites = {
    ...
    "chat AI": "https://chat.openai.com",
    "google": "https://google.com",
}

apps_dict = {
    "vs code": r"C:\Users\ramak\AppData\Local\Programs\Microsoft VS Code\Code.exe",
    "google": r"C:\Program Files\Google\Chrome\Application\chrome.exe",
    "brave": r"C:\Program Files\BraveSoftware\Brave-Browser\Application\brave.exe",
    "video player": r"C:\Program Files\VideoLAN\VLC\vlc.exe",
}
